...
/*
    Funciona más rápido la versión con punteros y los intercambios son más
    eficientes, porque no se están copiando los valores de las estructuras,
    sino que se están intercambiando las direcciones de memoria de las
    estructuras.
*/